...
Constants.cpp_keywords = {
  ...
  -- std::library
  "[](){}()", "[&](){}", "[=](){}", "std::deez_nuts",
  "std::unordered_map", "std::string", "std::vector", "std::map", "std::array",
  "std::set", "std::unordered_set",
  "std::back_inserter", "std::bitset", "std::cbegin", "std::cend",
  "std::chrono", "std::cin", "std::conditional", "std::cout", "std::cout",
  "std::decltype", "std::declval", "std::distance", "std::enable_if",
  "std::experimental", "std::filesystem", "std::forward", "std::free",
  "std::generate_n", "std::get", "std::getline", "std::hash", "std::ifstream",
  "std::initializer_list", "std::int16_t", "std::int32_t", "std::int64_t",
  "std::int8_t", "std::integral_constant", "std::is_trivially_copyable",
  "std::is_void", "std::isnan", "std::istringstream", "std::jthread",
  "std::lock_guard", "std::make_pair", "std::make_shared", "std::make_unique",
  "std::max_element", "std::memcpy", "std::min_element", "std::minmax",
  "std::move", "std::mt19937", "std::mutex", "std::nullopt",
  "std::numeric_limits", "std::ofstream", "std::optional",
  "std::random_device", "std::scoped_lock", "std::shared_ptr", "std::size_t",
  "std::sort", "std::string_view", "std::stringstream", "std::swap",
  "std::this_thread::sleep_for", "std::tuple", "std::uint16_t",
  "std::uint32_t", "std::uint64_t", "std::uint8_t",
  "std::uniform_int_distribution", "std::unique_ptr", "std::variant",
}
